...
const Organization = () => {
  ...
  async function hitMRN(mrntohit) {
    ...
    setPatientData();
    let mrnUrl =
      "https://ds-idev-func-okta-hit.azurewebsites.net/api/dsep/demo/org/" +
      currentToken +
      "/" +
      mrntohit;
    console.log(mrnUrl);
                      ...
                      <Table striped bordered hover size="sm">
                        <tbody className="responseTable">
                          ...
                          {entry.resource.extension && (
                            <tr>
                              <td>Dsep Care Coordination Consent:</td>
                              <td>
                                {String(
                                  entry.resource.extension[0].valueBoolean
                                )}
                              </td>
                            </tr>
                          )}
                          ...
                          {entry.resource.address && (
                            <tr>
                              <td>country:</td>
                              <td>{entry.resource.address[0].country}</td>
                            </tr>
                          )}
                        </tbody>
                      </Table>
